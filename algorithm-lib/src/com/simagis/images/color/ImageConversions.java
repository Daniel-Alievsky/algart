...
public class ImageConversions {
    ...
    /*Repeat() ToHue ==> ToSaturationHsv,,ToValue,,ToSaturationHsl,,ToLightness;;
               asHue ==> asHSVSaturation,,asHSVValue,,asHSLSaturation,,asHSLLightness
    */
    public static <T extends PArray> Matrix<T> asHue(
        Class<T> resultType,
        Image2D image)
    {
        return asHue(resultType, image.r(), image.g(), image.b());
    }
    ...
    public static <T extends PArray> Matrix<T> asHSVSaturation(
        ...
        Image2D image)
    {
        return asHSVSaturation(resultType, image.r(), image.g(), image.b());
    }
    ...
    public static <T extends PArray> Matrix<T> asHSVValue(
        ...
        Image2D image)
    {
        return asHSVValue(resultType, image.r(), image.g(), image.b());
    }
    ...
    public static <T extends PArray> Matrix<T> asHSLSaturation(
        ...
        Image2D image)
    {
        return asHSLSaturation(resultType, image.r(), image.g(), image.b());
    }
    ...
    public static <T extends PArray> Matrix<T> asHSLLightness(
        ...
        Image2D image)
    {
        return asHSLLightness(resultType, image.r(), image.g(), image.b());
    }
